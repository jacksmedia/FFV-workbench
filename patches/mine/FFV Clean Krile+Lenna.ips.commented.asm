;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=
; FFV Clean Krile+Lenna.ips.commented.asm
;    Disassembled from IPS patch: FFV Clean Krile+Lenna.ips
...
; Patch contains 432 record(s)

;--- Patch at file offset $00FFDC (SNES $C0FFDC) ---
org $C0FFDC

    BIT $C39B,X             ; [3C 9B C3   ] Test Bits Absolute,X
    db $64                      ; Incomplete/data bytes

;--- Patch at file offset $128420 (SNES $D28420) ---
org $D28420

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $128433 (SNES $D28433) ---
org $D28433

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $1284E0 (SNES $D284E0) ---
org $D284E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $1284F3 (SNES $D284F3) ---
org $D284F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $1285E8 (SNES $D285E8) ---
org $D285E8

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $1285FB (SNES $D285FB) ---
org $D285FB

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $1287E0 (SNES $D287E0) ---
org $D287E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $1287F3 (SNES $D287F3) ---
org $D287F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $128960 (SNES $D28960) ---
org $D28960

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $128973 (SNES $D28973) ---
org $D28973

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12A220 (SNES $D2A220) ---
org $D2A220

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12A233 (SNES $D2A233) ---
org $D2A233

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12A5E0 (SNES $D2A5E0) ---
org $D2A5E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12A5F3 (SNES $D2A5F3) ---
org $D2A5F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12B420 (SNES $D2B420) ---
org $D2B420

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12B433 (SNES $D2B433) ---
org $D2B433

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F020 (SNES $D2F020) ---
org $D2F020

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F033 (SNES $D2F033) ---
org $D2F033

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F0E0 (SNES $D2F0E0) ---
org $D2F0E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F0F3 (SNES $D2F0F3) ---
org $D2F0F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F1E8 (SNES $D2F1E8) ---
org $D2F1E8

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F1FB (SNES $D2F1FB) ---
org $D2F1FB

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F3E0 (SNES $D2F3E0) ---
org $D2F3E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F3F3 (SNES $D2F3F3) ---
org $D2F3F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F620 (SNES $D2F620) ---
org $D2F620

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F633 (SNES $D2F633) ---
org $D2F633

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F6E0 (SNES $D2F6E0) ---
org $D2F6E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F6F3 (SNES $D2F6F3) ---
org $D2F6F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F7E8 (SNES $D2F7E8) ---
org $D2F7E8

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F7FB (SNES $D2F7FB) ---
org $D2F7FB

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12F9E0 (SNES $D2F9E0) ---
org $D2F9E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12F9F3 (SNES $D2F9F3) ---
org $D2F9F3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12FB60 (SNES $D2FB60) ---
org $D2FB60

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12FB73 (SNES $D2FB73) ---
org $D2FB73

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12FC20 (SNES $D2FC20) ---
org $D2FC20

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12FC33 (SNES $D2FC33) ---
org $D2FC33

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $12FCF4 (SNES $D2FCF4) ---
org $D2FCF4

    CPX #$18                ; [E0 18      ] Compare X Immediate

;--- Patch at file offset $12FFE0 (SNES $D2FFE0) ---
org $D2FFE0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $12FFF3 (SNES $D2FFF3) ---
org $D2FFF3

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $130220 (SNES $D30220) ---
org $D30220

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $130233 (SNES $D30233) ---
org $D30233

    RTS                     ; [60         ] Return from Subroutine

;--- Patch at file offset $1302F4 (SNES $D302F4) ---
org $D302F4

    CPX #$18                ; [E0 18      ] Compare X Immediate

;--- Patch at file offset $1305E0 (SNES $D305E0) ---
org $D305E0

    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $F0                      ; Incomplete/data bytes

;--- Patch at file offset $1305F3 (SNES $D305F3) ---
org $D305F3
...
org $D41016
    ...
    BMI $1059               ; [30 EC      ] Branch if Minus
...
;--- Patch at file offset $1411B0 (SNES $D411B0) ---
org $D411B0

    CPY $C02C               ; [CC 2C C0   ] Compare Y with Absolute
    BMI $11B5               ; [30 00      ] Branch if Minus
...
org $D4126D
    ...
    BRK                     ; [00 E0      ] Software interrupt
    RTI                     ; [40         ] Return from Interrupt
    BVS $1308               ; [70 E0      ] Branch if Overflow Set
    CPX #$00                ; [E0 00      ] Compare X Immediate
    BVS $138C               ; [70 60      ] Branch if Overflow Set
    ...
    BNE $140E               ; [D0 60      ] Branch if Not Equal
    RTS                     ; [60         ] Return from Subroutine
    BRK                     ; [00 00      ] Software interrupt
    BVC $1333               ; [50 80      ] Branch if Overflow Clear
...
org $D4187A
    ...
    BMI $18EA               ; [30 3D      ] Branch if Minus
    BRK                     ; [00 18      ] Software interrupt
    BRK                     ; [00 0E      ] Software interrupt
    BRK                     ; [00 06      ] Software interrupt
    COP #$07                ; [02 07      ] Coprocessor interrupt
    ...
    CPX #$48                ; [E0 48      ] Compare X Immediate
    BCC $1945               ; [90 4C      ] Branch if Carry Clear
    BCC $1907               ; [90 0C      ] Branch if Carry Clear
    ...
    ORA $760022             ; [0F 22 00 76] OR A with Absolute Long
    BMI $19CA               ; [30 3D      ] Branch if Minus
    BRK                     ; [00 18      ] Software interrupt
...
org $D41C16
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
    BEQ $1C26               ; [F0 00      ] Branch if Equal
    CLV                     ; [B8         ] Clear Overflow Flag
    RTI                     ; [40         ] Return from Interrupt
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 20      ] Software interrupt
    BNE $1C49               ; [D0 10      ] Branch if Not Equal
    ...
    BPL $1CD5               ; [10 5C      ] Branch if Plus
    BRK                     ; [00 8C      ] Software interrupt
    BPL $1CE5               ; [10 68      ] Branch if Plus
    STZ $F0                 ; [64 F0      ] Store Zero to DP
    BEQ $1C1A               ; [F0 99      ] Branch if Equal
    ...
    BEQ $1CA6               ; [F0 00      ] Branch if Equal
    CPY #$80                ; [C0 80      ] Compare Y Immediate
    BRA $1CAA               ; [80 00      ] Branch Always
    BRA $1CAC               ; [80 00      ] Branch Always
    BRA $1CAE               ; [80 00      ] Branch Always
    BRK                     ; [00 00      ] Software interrupt
    BNE $1CD2               ; [D0 20      ] Branch if Not Equal
    CPY #$30                ; [C0 30      ] Compare Y Immediate
    BRK                     ; [00 00      ] Software interrupt
    BRA $1CB8               ; [80 00      ] Branch Always
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
...
org $D41CD6
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
    BEQ $1CE6               ; [F0 00      ] Branch if Equal
    CLV                     ; [B8         ] Clear Overflow Flag
    RTI                     ; [40         ] Return from Interrupt
    CLD                     ; [D8         ] Clear Decimal Flag
    JSR $C874               ; [20 74 C8   ] Jump to Subroutine
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 20      ] Software interrupt
    BNE $1D09               ; [D0 10      ] Branch if Not Equal
    JSR $98C0               ; [20 C0 98   ] Jump to Subroutine
    INY                     ; [C8         ] Increment Y
    TRB $E4                 ; [14 E4      ] Test and Reset Bits DP
    PHP                     ; [08         ] Push Processor Status
    ...
    BCS $1D1B               ; [B0 EC      ] Branch if Carry Set
    SEI                     ; [78         ] Set Interrupt Disable
    CPX $28                 ; [E4 28      ] Compare X with DP
    PLA                     ; [68         ] Pull Accumulator
    BRK                     ; [00 68      ] Software interrupt
    BRK                     ; [00 48      ] Software interrupt
    BPL $1D95               ; [10 5C      ] Branch if Plus
    ...
    BPL $1D7A               ; [10 2D      ] Branch if Plus

;--- Patch at file offset $141D5A (SNES $D41D5A) ---
org $D41D5A
    ...
    BRK                     ; [00 00      ] Software interrupt
    INY                     ; [C8         ] Increment Y
    BRA $1D4B               ; [80 E8      ] Branch Always
    RTS                     ; [60         ] Return from Subroutine
    TYA                     ; [98         ] Transfer Y to A
    BPL $1CF7               ; [10 90      ] Branch if Plus
    BRK                     ; [00 60      ] Software interrupt
    BRK                     ; [00 A0      ] Software interrupt
    BRA $1D4D               ; [80 E0      ] Branch Always
    CPY #$E0                ; [C0 E0      ] Compare Y Immediate
    BRK                     ; [00 A0      ] Software interrupt
    BPL $1D73               ; [10 00      ] Branch if Plus
    BVS $1DD5               ; [70 60      ] Branch if Overflow Set
    BPL $1DD7               ; [10 60      ] Branch if Plus
    BRK                     ; [00 80      ] Software interrupt
    BRK                     ; [00 40      ] Software interrupt
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
...
;--- Patch at file offset $141D9A (SNES $D41D9A) ---
org $D41D9A
    ...
    PLP                     ; [28         ] Pull Processor Status
    JSR $2028               ; [20 28 20   ] Jump to Subroutine
    BEQ $1DA6               ; [F0 00      ] Branch if Equal
    CPX #$C0                ; [E0 C0      ] Compare X Immediate
    JSR $B000               ; [20 00 B0   ] Jump to Subroutine
    LDY #$E0                ; [A0 E0      ] Load Y Immediate
    CPY #$C0                ; [C0 C0      ] Compare Y Immediate
    BRK                     ; [00 C0      ] Software interrupt
    BMI $1D73               ; [30 C0      ] Branch if Minus
    BMI $1DB5               ; [30 00      ] Branch if Minus
    BRK                     ; [00 C0      ] Software interrupt
    BRK                     ; [00 40      ] Software interrupt
    BRA $1DFB               ; [80 40      ] Branch Always
    CPX #$00                ; [E0 00      ] Compare X Immediate
...
;--- Patch at file offset $141EBA (SNES $D41EBA) ---
org $D41EBA
    ...
    INC $FE40,X             ; [FE 40 FE   ] Increment Absolute,X
    BRK                     ; [00 FE      ] Software interrupt
    BRA $1F6B               ; [80 7C      ] Branch Always
    CPY #$E4                ; [C0 E4      ] Compare Y Immediate
    PLP                     ; [28         ] Pull Processor Status
    PLA                     ; [68         ] Pull Accumulator
    BRK                     ; [00 68      ] Software interrupt
    BRK                     ; [00 48      ] Software interrupt
    BPL $1F55               ; [10 5C      ] Branch if Plus
    BRK                     ; [00 0C      ] Software interrupt
    BMI $1E85               ; [30 88      ] Branch if Minus
    LDY $C0,X               ; [B4 C0      ] Load Y from DP,X
    CLD                     ; [D8         ] Clear Decimal Flag

;--- Patch at file offset $141F06 (SNES $D41F06) ---
org $D41F06
...
;--- Patch at file offset $141F1A (SNES $D41F1A) ---
org $D41F1A
    ...
    BRK                     ; [00 40      ] Software interrupt
    RTI                     ; [40         ] Return from Interrupt
    BRA $1F34               ; [80 00      ] Branch Always
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    BRA $1F38               ; [80 00      ] Branch Always
    RTI                     ; [40         ] Return from Interrupt
    BRA $1F7B               ; [80 40      ] Branch Always
    CPX #$00                ; [E0 00      ] Compare X Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 20      ] Software interrupt
    BNE $1F69               ; [D0 10      ] Branch if Not Equal
    JSR $98C0               ; [20 C0 98   ] Jump to Subroutine
    INY                     ; [C8         ] Increment Y
    TRB $E4                 ; [14 E4      ] Test and Reset Bits DP
    PHP                     ; [08         ] Push Processor Status
    ...
    CLI                     ; [58         ] Clear Interrupt Disable
    BRK                     ; [00 00      ] Software interrupt
    BMI $1F1F               ; [30 A4      ] Branch if Minus
    BNE $1FDD               ; [D0 60      ] Branch if Not Equal
    TRB $C0                 ; [14 C0      ] Test and Reset Bits DP
    PLP                     ; [28         ] Pull Processor Status

;--- Patch at file offset $141F86 (SNES $D41F86) ---
org $D41F86
...
;--- Patch at file offset $141F9A (SNES $D41F9A) ---
org $D41F9A
    ...
    BRK                     ; [00 20      ] Software interrupt
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    BRA $1FB8               ; [80 00      ] Branch Always
    RTI                     ; [40         ] Return from Interrupt
    BRA $1FFB               ; [80 40      ] Branch Always
    CPX #$00                ; [E0 00      ] Compare X Immediate
    db $C0                      ; Incomplete/data bytes
...
org $D41FD6
    ...
    BRK                     ; [00 BE      ] Software interrupt
    BMI $2047               ; [30 1E      ] Branch if Minus
    BRA $1FC7               ; [80 9C      ] Branch Always
    BRK                     ; [00 18      ] Software interrupt
    BRK                     ; [00 B0      ] Software interrupt
    BRA $2075               ; [80 44      ] Branch Always
    BRK                     ; [00 24      ] Software interrupt
    BPL $2059               ; [10 24      ] Branch if Plus
    BPL $207B               ; [10 44      ] Branch if Plus
    BMI $2001               ; [30 C8      ] Branch if Minus
    LDY $48                 ; [A4 48      ] Load Y from DP
    JSR $A040               ; [20 40 A0   ] Jump to Subroutine
    BRA $2080               ; [80 40      ] Branch Always
...
org $D42156
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 20      ] Software interrupt
    BNE $2189               ; [D0 10      ] Branch if Not Equal
...
org $D42E16
    ...
    BMI $2E03               ; [30 96      ] Branch if Minus
    SEI                     ; [78         ] Set Interrupt Disable
...
org $D42ED8
    ...
    BRK                     ; [00 00      ] Software interrupt
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    BCS $2F26               ; [B0 40      ] Branch if Carry Set
    INY                     ; [C8         ] Increment Y
    ...
    TSB $48                 ; [04 48      ] Test and Set Bits in DP
    BIT $10                 ; [24 10      ] Test Bits DP
    BMI $2F3C               ; [30 00      ] Branch if Minus
    SEI                     ; [78         ] Set Interrupt Disable
    BRK                     ; [00 78      ] Software interrupt
...
org $D42FFB
    ...
    BCC $2FCE               ; [90 94      ] Branch if Carry Clear
    BCC $2FF0               ; [90 B4      ] Branch if Carry Clear
...
;--- Patch at file offset $143115 (SNES $D43115) ---
org $D43115
...
org $D431D6
    ...
    BRK                     ; [00 CE      ] Software interrupt
    BRK                     ; [00 FE      ] Software interrupt
    BVS $3227               ; [70 FE      ] Branch if Overflow Set
    RTS                     ; [60         ] Return from Subroutine
    ASL $1400,X             ; [1E 00 14   ] Shift Left Absolute,X
    PHP                     ; [08         ] Push Processor Status
    PLP                     ; [28         ] Pull Processor Status
    BPL $3235               ; [10 04      ] Branch if Plus
    BRK                     ; [00 24      ] Software interrupt
    BPL $3259               ; [10 24      ] Branch if Plus
    BPL $32AB               ; [10 74      ] Branch if Plus
    PHP                     ; [08         ] Push Processor Status
    STZ $08                 ; [64 08      ] Store Zero to DP
...
org $D43356
    ...
    ORA ($1F,X)             ; [01 1F      ] OR A with (DP,X)
    BRK                     ; [00 00      ] Software interrupt
    TSB $0E03               ; [0C 03 0E   ] Test and Set Bits Absolute
    ORA ($06,X)             ; [01 06      ] OR A with (DP,X)
    BRK                     ; [00 0F      ] Software interrupt
    BRK                     ; [00 34      ] Software interrupt
...
org $D43940
    ...
    BCC $3A85               ; [90 08      ] Branch if Carry Clear
    TSB $60                 ; [04 60      ] Test and Set Bits in DP
    PHP                     ; [08         ] Push Processor Status
...
;--- Patch at file offset $143BFA (SNES $D43BFA) ---
org $D43BFA
...
org $D43C2E
    ...
    BRK                     ; [00 00      ] Software interrupt
    EOR $002C20,X           ; [5F 20 2C 00] XOR A with Absolute Long,X
    ASL $04,X               ; [16 04      ] Shift Left DP,X
    TRB $06                 ; [14 06      ] Test and Reset Bits DP
    TRB $06                 ; [14 06      ] Test and Reset Bits DP
    BPL $3C8C               ; [10 00      ] Branch if Plus
    ORA #$00                ; [09 00      ] OR A with Immediate
    ORA $3F0001             ; [0F 01 00 3F] OR A with Absolute Long
    COP #$11                ; [02 11      ] Coprocessor interrupt
    PHP                     ; [08         ] Push Processor Status
    ORA ($08,X)             ; [01 08      ] OR A with (DP,X)
    ORA ($08,X)             ; [01 08      ] OR A with (DP,X)
    ...
    ORA #$00                ; [09 00      ] OR A with Immediate
    ASL $0001,X             ; [1E 01 00   ] Shift Left Absolute,X
    AND $081102,X           ; [3F 02 11 08] AND A with Absolute Long,X
    ORA ($08,X)             ; [01 08      ] OR A with (DP,X)
    ORA ($08,X)             ; [01 08      ] OR A with (DP,X)
    ORA ($0E,X)             ; [01 0E      ] OR A with (DP,X)
    ORA ($06,X)             ; [01 06      ] OR A with (DP,X)
    ...
    BCC $3D07               ; [90 0C      ] Branch if Carry Clear
    BCC $3D05               ; [90 08      ] Branch if Carry Clear
    TRB $E0                 ; [14 E0      ] Test and Reset Bits DP
    PHP                     ; [08         ] Push Processor Status
    ...
    SED                     ; [F8         ] Set Decimal Flag
    CPX #$60                ; [E0 60      ] Compare X Immediate
    BRA $3D05               ; [80 E0      ] Branch Always
    CPY #$C0                ; [C0 C0      ] Compare Y Immediate
    BRA $3D49               ; [80 20      ] Branch Always
    RTI                     ; [40         ] Return from Interrupt
    BVC $3D0C               ; [50 E0      ] Branch if Overflow Clear
    CPX #$40                ; [E0 40      ] Compare X Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    CPX #$00                ; [E0 00      ] Compare X Immediate
    BRA $3CB4               ; [80 80      ] Branch Always
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    BRA $3D38               ; [80 00      ] Branch Always
    RTI                     ; [40         ] Return from Interrupt
    CPY #$A0                ; [C0 A0      ] Compare Y Immediate
    CPX #$80                ; [E0 80      ] Compare X Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    ...
    CPY #$20                ; [C0 20      ] Compare Y Immediate
    RTI                     ; [40         ] Return from Interrupt
    BVC $3D8C               ; [50 E0      ] Branch if Overflow Clear
    CPX #$40                ; [E0 40      ] Compare X Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    CPY #$00                ; [C0 00      ] Compare Y Immediate
    CPY #$E0                ; [C0 E0      ] Compare Y Immediate
    ...
    JMP ($3900,X)           ; [7C 00 39   ] Jump Indirect,X
    BRK                     ; [00 1C      ] Software interrupt
    BRK                     ; [00 24      ] Software interrupt
    BRK                     ; [00 2E      ] Software interrupt
    PHP                     ; [08         ] Push Processor Status
...
org $D44556
    ...
    ORA ($16,X)             ; [01 16      ] OR A with (DP,X)
    BRK                     ; [00 3D      ] Software interrupt
    ORA $F8EC               ; [0D EC F8   ] OR A with Absolute
    INC $BC,X               ; [F6 BC      ] Increment DP,X
    INC $1C,X               ; [F6 1C      ] Increment DP,X
    LDX $1C,Y               ; [B6 1C      ] Load X from DP,Y
    LDY $5C18               ; [AC 18 5C   ] Load Y from Absolute
    SEC                     ; [38         ] Set Carry Flag
    CLD                     ; [D8         ] Clear Decimal Flag
    BVS $465B               ; [70 EC      ] Branch if Overflow Set
    CLC                     ; [18         ] Clear Carry Flag
    SED                     ; [F8         ] Set Decimal Flag
    DEY                     ; [88         ] Decrement Y
    LDY $9C80,X             ; [BC 80 9C   ] Load Y from Absolute,X
    RTI                     ; [40         ] Return from Interrupt
    JML [$D804]             ; [DC 04 D8   ] Jump Long Indirect
    BRK                     ; [00 38      ] Software interrupt
    DEY                     ; [88         ] Decrement Y
...
org $D44710
    ...
    SEI                     ; [78         ] Set Interrupt Disable
    DEY                     ; [88         ] Decrement Y
    TRB $9CC0               ; [1C C0 9C   ] Test and Reset Bits Absolute
    RTI                     ; [40         ] Return from Interrupt
    ...
    PLX                     ; [FA         ] Pull X Register
    TSB $043E               ; [0C 3E 04   ] Test and Set Bits Absolute
    ROL $3EC4,X             ; [3E C4 3E   ] Rotate Left Absolute,X
...
org $D4478A
    ...
    PER $7EB2               ; [62 25 37   ] Push Effective Relative
    ORA ($1F)               ; [12 1F      ] OR A with (DP)
    BRK                     ; [00 60      ] Software interrupt
    TSB $2E46               ; [0C 46 2E   ] Test and Set Bits Absolute
...
org $D447FC
    ...
    JSR ($7C26,X)           ; [FC 26 7C   ] Jump to Subroutine Indirect,X

;--- Patch at file offset $144830 (SNES $D44830) ---
org $D44830

    JSR ($E030,X)           ; [FC 30 E0   ] Jump to Subroutine Indirect,X
    CLC                     ; [18         ] Clear Carry Flag
    JSR ($3C84,X)           ; [FC 84 3C   ] Jump to Subroutine Indirect,X
    CPY #$DE                ; [C0 DE      ] Compare Y Immediate
    db $42                      ; Incomplete/data bytes

;--- Patch at file offset $144840 (SNES $D44840) ---
org $D44840

    PLY                     ; [7A         ] Pull Y Register
    ROL $38,X               ; [36 38      ] Rotate Left DP,X
    BPL $4863               ; [10 1E      ] Branch if Plus
    PHP                     ; [08         ] Push Processor Status
    AND $6706,Y             ; [39 06 67   ] AND A with Absolute,Y
    AND #$63                ; [29 63      ] AND A with Immediate
    AND $62                 ; [25 62      ] AND A with Direct Page
...
org $D44866
    ...
    JSL $FF4227             ; [22 27 42 FF] Jump to Subroutine Long
    BRK                     ; [00 0C      ] Software interrupt
...
org $D448AA
    ...
    PER $7FD2               ; [62 25 37   ] Push Effective Relative
    BPL $48C8               ; [10 19      ] Branch if Plus
    BRK                     ; [00 20      ] Software interrupt
...
org $D448BA
    ...
    SED                     ; [F8         ] Set Decimal Flag
    INC $FC,X               ; [F6 FC      ] Increment DP,X
    INC $1C,X               ; [F6 1C      ] Increment DP,X
    LDX $1C,Y               ; [B6 1C      ] Load X from DP,Y
    LDY $5C18               ; [AC 18 5C   ] Load Y from Absolute
    SEC                     ; [38         ] Set Carry Flag
    CLD                     ; [D8         ] Clear Decimal Flag
    BVS $48DB               ; [70 EC      ] Branch if Overflow Set
    CLC                     ; [18         ] Clear Carry Flag
    SED                     ; [F8         ] Set Decimal Flag
    DEY                     ; [88         ] Decrement Y
    JSR ($9CC0,X)           ; [FC C0 9C   ] Jump to Subroutine Indirect,X
    RTI                     ; [40         ] Return from Interrupt
    JML [$D804]             ; [DC 04 D8   ] Jump Long Indirect
    BRK                     ; [00 38      ] Software interrupt
    DEY                     ; [88         ] Decrement Y
    BVS $48FE               ; [70 00      ] Branch if Overflow Set
    CLC                     ; [18         ] Clear Carry Flag
    PHP                     ; [08         ] Push Processor Status
    ...
    JSL $25621D             ; [22 1D 62 25] Jump to Subroutine Long
...
org $D44914
    ...
    BIT $1CC8,X             ; [3C C8 1C   ] Test Bits Absolute,X
    PHP                     ; [08         ] Push Processor Status
    SED                     ; [F8         ] Set Decimal Flag
    ...
    STY $CC40               ; [8C 40 CC   ] Store Y to Absolute
    BRK                     ; [00 C8      ] Software interrupt
    CLC                     ; [18         ] Clear Carry Flag
    PHP                     ; [08         ] Push Processor Status
    SEC                     ; [38         ] Set Carry Flag
...
org $D4498A
    ...
    PER $80B2               ; [62 25 37   ] Push Effective Relative
    ORA ($1F)               ; [12 1F      ] OR A with (DP)
    BRK                     ; [00 60      ] Software interrupt
    db $0D, $46                 ; Incomplete/data bytes
...
org $D4499A
    ...
    LDY $10,X               ; [B4 10      ] Load Y from DP,X
    STZ $30,X               ; [74 30      ] Store Zero to DP,X
    PEA $E870               ; [F4 70 E8   ] Push Effective Absolute
    RTS                     ; [60         ] Return from Subroutine
    PEI ($C8)               ; [D4 C8      ] Push Effective Indirect
    CLD                     ; [D8         ] Clear Decimal Flag
    ...
    PEI ($C8)               ; [D4 C8      ] Push Effective Indirect
    LDY $7C88,X             ; [BC 88 7C   ] Load Y from Absolute,X
    DEY                     ; [88         ] Decrement Y
...
org $D44A96
    ...
    STA $02050A             ; [8F 0A 05 02] Store A to Absolute Long
...
org $D44B00
    ...
    JSL $EB86AF             ; [22 AF 86 EB] Jump to Subroutine Long
    ...
    BRK                     ; [00 25      ] Software interrupt
    ORA $2858,X             ; [1D 58 28   ] OR A with Absolute,X
    SEI                     ; [78         ] Set Interrupt Disable
    ...
    ORA $2F07,X             ; [1D 07 2F   ] OR A with Absolute,X
    PHP                     ; [08         ] Push Processor Status
    AND [$10],Y             ; [37 10      ] AND A with [DP],Y
    AND ($10,S),Y           ; [33 10      ] AND A with (SR),Y
    ...
    TRB $1C66               ; [1C 66 1C   ] Test and Reset Bits Absolute
    LDX $1C                 ; [A6 1C      ] Load X from DP
    ...
    SED                     ; [F8         ] Set Decimal Flag
    DEY                     ; [88         ] Decrement Y
    TRB $1CC0               ; [1C C0 1C   ] Test and Reset Bits Absolute
    BRA $4BD3               ; [80 1C      ] Branch Always
    MVP $18,$C0             ; [44 18 C0   ] Block Move Positive
    SEC                     ; [38         ] Set Carry Flag
    DEY                     ; [88         ] Decrement Y
...
org $D44C5A
    ...
    CLV                     ; [B8         ] Clear Overflow Flag
    TAY                     ; [A8         ] Transfer A to Y
    BNE $4C63               ; [D0 FC      ] Branch if Not Equal
    PLA                     ; [68         ] Pull Accumulator
    JSR ($1E08,X)           ; [FC 08 1E   ] Jump to Subroutine Indirect,X
    STZ $1C                 ; [64 1C      ] Store Zero to DP
    ...
    SED                     ; [F8         ] Set Decimal Flag
    SED                     ; [F8         ] Set Decimal Flag
    BVS $4C66               ; [70 F0      ] Branch if Overflow Set
    BPL $4CF0               ; [10 78      ] Branch if Plus
    BPL $4C92               ; [10 18      ] Branch if Plus
    INX                     ; [E8         ] Increment X
    STY $00F0               ; [8C F0 00   ] Store Y to Absolute
    SEC                     ; [38         ] Set Carry Flag
    BRK                     ; [00 7D      ] Software interrupt
    ASL $1E79               ; [0E 79 1E   ] Shift Left Absolute
    SEI                     ; [78         ] Set Interrupt Disable
    ORA $502750             ; [0F 50 27 50] OR A with Absolute Long
    AND [$51]               ; [27 51      ] AND A with [DP]
    AND [$68]               ; [27 68      ] AND A with [DP]
    ORA $3E007F             ; [0F 7F 00 3E] OR A with Absolute Long
    BMI $4CC1               ; [30 2E      ] Branch if Minus
    BMI $4CA4               ; [30 0F      ] Branch if Minus
    BRK                     ; [00 2F      ] Software interrupt
    PHP                     ; [08         ] Push Processor Status
    AND $082F08             ; [2F 08 2F 08] AND A with Absolute Long
    ORA $000010,X           ; [1F 10 00 00] OR A with Absolute Long,X
...
org $D44CD8
    ...
    SEC                     ; [38         ] Set Carry Flag
    SED                     ; [F8         ] Set Decimal Flag
    db $BC, $FC                 ; Incomplete/data bytes

;--- Patch at file offset $144D07 (SNES $D44D07) ---
org $D44D07

    AND $3F                 ; [25 3F      ] AND A with Direct Page
    ORA $2F                 ; [05 2F      ] OR A with Direct Page
    BRK                     ; [00 7E      ] Software interrupt
    JSR $247F               ; [20 7F 24   ] Jump to Subroutine
    db $3F, $7F                 ; Incomplete/data bytes
...
org $D44D1E
    ...
    JSR $7018               ; [20 18 70   ] Jump to Subroutine
    CLD                     ; [D8         ] Clear Decimal Flag
    BMI $4D1D               ; [30 EC      ] Branch if Minus
    CPX $7878               ; [EC 78 78   ] Compare X with Absolute
    SEC                     ; [38         ] Set Carry Flag
    SEC                     ; [38         ] Set Carry Flag
    CLC                     ; [18         ] Clear Carry Flag
    TRB $0C08               ; [1C 08 0C   ] Test and Reset Bits Absolute
    RTS                     ; [60         ] Return from Subroutine
    RTI                     ; [40         ] Return from Interrupt
    BEQ $4CBE               ; [F0 80      ] Branch if Equal
    BMI $4D40               ; [30 00      ] Branch if Minus
    CMP $79CF70,X           ; [DF 70 CF 79] Compare A with Absolute Long,X
    CMP $66C97A             ; [CF 7A C9 66] Compare A with Absolute Long
    CMP #$67                ; [C9 67      ] Compare A Immediate
    STA ($4F),Y             ; [91 4F      ] Store A to (DP),Y
    LDA $FF1F,Y             ; [B9 1F FF   ] Load A from Absolute,Y
    BRK                     ; [00 73      ] Software interrupt
    ORA $7A,S               ; [03 7A      ] OR A with Stack Relative
    ORA $7A,S               ; [03 7A      ] OR A with Stack Relative
    BRK                     ; [00 76      ] Software interrupt
...
org $D44D60
    ...
    BRK                     ; [00 7C      ] Software interrupt
    ORA $781F78             ; [0F 78 1F 78] OR A with Absolute Long
    ORA $682751             ; [0F 51 27 68] OR A with Absolute Long
    ORA $73035F             ; [0F 5F 03 73] OR A with Absolute Long
    TRB $007F               ; [1C 7F 00   ] Test and Reset Bits Absolute
    AND $302F30,X           ; [3F 30 2F 30] AND A with Absolute Long,X
    ORA $082F00             ; [0F 00 2F 08] OR A with Absolute Long
    ORA $202310,X           ; [1F 10 23 20] OR A with Absolute Long,X
    ...
    CPY $E472               ; [CC 72 E4   ] Compare Y with Absolute
    ROR $FCF4,X             ; [7E F4 FC   ] Rotate Right Absolute,X
    BRK                     ; [00 D8      ] Software interrupt
    CPY #$98                ; [C0 98      ] Compare Y Immediate
...
org $D44DFA
    ...
    SEC                     ; [38         ] Set Carry Flag
    CLC                     ; [18         ] Clear Carry Flag
    BCS $4DD5               ; [B0 A8      ] Branch if Carry Set
    BNE $4E2B               ; [D0 FC      ] Branch if Not Equal
    PLA                     ; [68         ] Pull Accumulator
    ...
    BVS $4E2E               ; [70 F0      ] Branch if Overflow Set
    BPL $4EB8               ; [10 78      ] Branch if Plus
    ORA $002F04             ; [0F 04 2F 00] OR A with Absolute Long
    JSR $3110               ; [20 10 31   ] Jump to Subroutine
    ORA $7D1F31,X           ; [1F 31 1F 7D] OR A with Absolute Long,X
    ASL $117F               ; [0E 7F 11   ] Shift Left Absolute
    ...
    ORA $010F00,X           ; [1F 00 0F 01] OR A with Absolute Long,X
    JSR $0031               ; [20 31 00   ] Jump to Subroutine
    BRK                     ; [00 FC      ] Software interrupt
    PHP                     ; [08         ] Push Processor Status
    ROL $9C64,X             ; [3E 64 9C   ] Rotate Left Absolute,X
    ...
    INX                     ; [E8         ] Increment X
    STY $0070               ; [8C 70 00   ] Store Y to Absolute
    SEI                     ; [78         ] Set Interrupt Disable
    BRK                     ; [00 78      ] Software interrupt
    BRK                     ; [00 F0      ] Software interrupt
...
org $D44E9A
    ...
    ORA $000F0F,X           ; [1F 0F 0F 00] OR A with Absolute Long,X
    ORA $190E,X             ; [1D 0E 19   ] OR A with Absolute,X
...
org $D44EDA
    ...
    TRB $030C               ; [1C 0C 03   ] Test and Reset Bits Absolute
    ORA $3C,S               ; [03 3C      ] OR A with Stack Relative
    SEC                     ; [38         ] Set Carry Flag
    BPL $4E9C               ; [10 B8      ] Branch if Plus
    TAY                     ; [A8         ] Transfer A to Y
    BNE $4EE3               ; [D0 FC      ] Branch if Not Equal
    PLA                     ; [68         ] Pull Accumulator
    ...
    SED                     ; [F8         ] Set Decimal Flag
    SED                     ; [F8         ] Set Decimal Flag
    BVS $4EE6               ; [70 F0      ] Branch if Overflow Set
    BPL $4F70               ; [10 78      ] Branch if Plus
    BPL $4F12               ; [10 18      ] Branch if Plus
    PHA                     ; [48         ] Push Accumulator
    TSB $80E0               ; [0C E0 80   ] Test and Set Bits Absolute
    CPX #$00                ; [E0 00      ] Compare X Immediate
    ASL $1E01,X             ; [1E 01 1E   ] Shift Left Absolute,X
    ORA $1E                 ; [05 1E      ] OR A with Direct Page
    BRK                     ; [00 12      ] Software interrupt
    TSB $29                 ; [04 29      ] Test and Set Bits in DP
    ASL $035F               ; [0E 5F 03   ] Shift Left Absolute
    ADC ($1C,S),Y           ; [73 1C      ] Add with Carry (SR),Y
    ADC $0C0D00,X           ; [7F 00 0D 0C] Add with Carry Absolute Long,X
    ORA #$0C                ; [09 0C      ] OR A with Immediate
    ORA ($01,X)             ; [01 01      ] OR A with (DP,X)
    ORA $1E09               ; [0D 09 1E   ] OR A with Absolute
    BPL $4F3E               ; [10 23      ] Branch if Plus
    ...
    CPX #$18                ; [E0 18      ] Compare X Immediate
    BVS $4F37               ; [70 0C      ] Branch if Overflow Set
    SEI                     ; [78         ] Set Interrupt Disable
    STZ $FC18               ; [9C 18 FC   ] Store Zero to Absolute
    BRK                     ; [00 E0      ] Software interrupt
    BRK                     ; [00 F0      ] Software interrupt
    BRK                     ; [00 F0      ] Software interrupt
    BRK                     ; [00 E0      ] Software interrupt
    BRK                     ; [00 F0      ] Software interrupt
    BRA $4F33               ; [80 F8      ] Branch Always
    ...
    BIT $1038,X             ; [3C 38 10   ] Test Bits Absolute,X
    CLV                     ; [B8         ] Clear Overflow Flag
    LDY $FCF0               ; [AC F0 FC   ] Load Y from Absolute
    RTI                     ; [40         ] Return from Interrupt
    JSR ($3E08,X)           ; [FC 08 3E   ] Jump to Subroutine Indirect,X
    TSB $1C                 ; [04 1C      ] Test and Set Bits in DP
    BEQ $4F7B               ; [F0 0C      ] Branch if Equal
    SED                     ; [F8         ] Set Decimal Flag
    INY                     ; [C8         ] Increment Y
    INY                     ; [C8         ] Increment Y
    SED                     ; [F8         ] Set Decimal Flag
    SED                     ; [F8         ] Set Decimal Flag
    BVC $4F66               ; [50 F0      ] Branch if Overflow Clear
    CLC                     ; [18         ] Clear Carry Flag
    CLI                     ; [58         ] Clear Interrupt Disable
    BPL $4F92               ; [10 18      ] Branch if Plus
    CPY #$C4                ; [C0 C4      ] Compare Y Immediate
    BEQ $4F7E               ; [F0 00      ] Branch if Equal
    SED                     ; [F8         ] Set Decimal Flag
    BRK                     ; [00 7C      ] Software interrupt
    ORA $781F78             ; [0F 78 1F 78] OR A with Absolute Long
    ORA $682750             ; [0F 50 27 68] OR A with Absolute Long
    ORA $73035E             ; [0F 5E 03 73] OR A with Absolute Long
    TRB $007F               ; [1C 7F 00   ] Test and Reset Bits Absolute
    AND $302F30,X           ; [3F 30 2F 30] AND A with Absolute Long,X
    ORA $082F00             ; [0F 00 2F 08] OR A with Absolute Long
    ORA $202310,X           ; [1F 10 23 20] OR A with Absolute Long,X
    ...
    BRK                     ; [00 0C      ] Software interrupt
    CLV                     ; [B8         ] Clear Overflow Flag
    ASL $BC                 ; [06 BC      ] Shift Left DP
    STX $BC                 ; [86 BC      ] Store X to DP
    DEC $9C                 ; [C6 9C      ] Decrement DP
    LSR $9C                 ; [46 9C      ] Shift Right DP
    JMP ($6CC8)             ; [6C C8 6C   ] Jump Indirect
    INY                     ; [C8         ] Increment Y
    SED                     ; [F8         ] Set Decimal Flag
    BRK                     ; [00 F8      ] Software interrupt
    RTI                     ; [40         ] Return from Interrupt
    JSR ($FC40,X)           ; [FC 40 FC   ] Jump to Subroutine Indirect,X
    RTI                     ; [40         ] Return from Interrupt
    LDY $BC20,X             ; [BC 20 BC   ] Load Y from Absolute,X
    JSR $10D8               ; [20 D8 10   ] Jump to Subroutine
    CLD                     ; [D8         ] Clear Decimal Flag
    db $10                      ; Incomplete/data bytes
...
org $D44FD8
    ...
    ADC $006F24,X           ; [7F 24 6F 00] Add with Carry Absolute Long,X
    EOR $304020             ; [4F 20 40 30] XOR A with Absolute Long
    BVC $503D               ; [50 2F      ] Branch if Overflow Clear
    CLI                     ; [58         ] Clear Interrupt Disable
    AND $201000             ; [2F 00 10 20] AND A with Absolute Long
    JSR $2000               ; [20 00 20   ] Jump to Subroutine
    BPL $5028               ; [10 10      ] Branch if Plus
    BMI $502A               ; [30 10      ] Branch if Minus
    AND $002F0F,X           ; [3F 0F 2F 00] AND A with Absolute Long,X
    AND $B81000             ; [2F 00 10 B8] AND A with Absolute Long
    TAY                     ; [A8         ] Transfer A to Y
    BVC $5021               ; [50 FC      ] Branch if Overflow Clear
    BPL $5023               ; [10 FC      ] Branch if Plus
    ...
    SED                     ; [F8         ] Set Decimal Flag
    SED                     ; [F8         ] Set Decimal Flag
    BVC $5084               ; [50 50      ] Branch if Overflow Clear
    JSR $2030               ; [20 30 20   ] Jump to Subroutine
    BMI $4FF9               ; [30 C0      ] Branch if Minus
    STY $70                 ; [84 70      ] Store Y to DP
    BRK                     ; [00 F0      ] Software interrupt
    RTI                     ; [40         ] Return from Interrupt
    SED                     ; [F8         ] Set Decimal Flag
    RTI                     ; [40         ] Return from Interrupt
    JML $33482F             ; [5C 2F 48 33] Jump Long
    PLP                     ; [28         ] Pull Processor Status
    ORA ($38,S),Y           ; [13 38      ] OR A with (SR),Y
    ORA ($18,S),Y           ; [13 18      ] OR A with (SR),Y
    ORA $19,S               ; [03 19      ] OR A with Stack Relative
    ORA $10,S               ; [03 10      ] OR A with Stack Relative
    ORA $1F,S               ; [03 1F      ] OR A with Stack Relative
    BRK                     ; [00 2F      ] Software interrupt
    BRK                     ; [00 37      ] Software interrupt
...
;--- Patch at file offset $1450D0 (SNES $D450D0) ---
org $D450D0
...
org $D450E2
    ...
    PHP                     ; [08         ] Push Processor Status
    PHP                     ; [08         ] Push Processor Status
    JMP ($6460)             ; [6C 60 64   ] Jump Indirect
    RTS                     ; [60         ] Return from Subroutine
    PHP                     ; [08         ] Push Processor Status
    RTS                     ; [60         ] Return from Subroutine
    STA $9137,Y             ; [99 37 91   ] Store A to Absolute,Y
    AND [$91]               ; [27 91      ] AND A with [DP]
    AND [$A1]               ; [27 A1      ] AND A with [DP]
    EOR $410EE1             ; [4F E1 0E 41] XOR A with Absolute Long
    db $1E                      ; Incomplete/data bytes

;--- Patch at file offset $145118 (SNES $D45118) ---
org $D45118

    ASL $3E10,X             ; [1E 10 3E   ] Shift Left Absolute,X
    JSR $000F               ; [20 0F 00   ] Jump to Subroutine
    BRK                     ; [00 00      ] Software interrupt
    INC $9C                 ; [E6 9C      ] Increment DP
    DEC $9C                 ; [C6 9C      ] Decrement DP
...
org $D4519A
    ...
    BRK                     ; [00 00      ] Software interrupt
    AND ($20,X)             ; [21 20      ] AND A with (DP,X)
    AND $383C2C             ; [2F 2C 3C 38] AND A with Absolute Long
    CLC                     ; [18         ] Clear Carry Flag
    BCS $514D               ; [B0 A8      ] Branch if Carry Set
    BEQ $51A3               ; [F0 FC      ] Branch if Equal
    CLI                     ; [58         ] Clear Interrupt Disable
    JSR ($1E28,X)           ; [FC 28 1E   ] Jump to Subroutine Indirect,X
    CPX $3C                 ; [E4 3C      ] Compare X with DP
    BEQ $51E7               ; [F0 38      ] Branch if Equal
    ...
    SEC                     ; [38         ] Set Carry Flag
    INX                     ; [E8         ] Increment X
    TSB $00F0               ; [0C F0 00   ] Test and Set Bits Absolute
    ...
    TSB $1F                 ; [04 1F      ] Test and Set Bits in DP
    BRK                     ; [00 3E      ] Software interrupt
    ORA ($7E,X)             ; [01 7E      ] OR A with (DP,X)
    ORA ($1F,S),Y           ; [13 1F      ] OR A with (SR),Y
    db $3F, $00, $11            ; Incomplete/data bytes
...
org $D451DA
    ...
    BRK                     ; [00 00      ] Software interrupt
    ORA $14,X               ; [15 14      ] OR A with DP,X
    AND $36                 ; [25 36      ] AND A with Direct Page
    ...
    JSR ($1E28,X)           ; [FC 28 1E   ] Jump to Subroutine Indirect,X
    CPX $3C                 ; [E4 3C      ] Compare X with DP
    BEQ $5227               ; [F0 38      ] Branch if Equal
...
org $D45216
    ...
    BMI $5257               ; [30 06      ] Branch if Minus
...
org $D455D7
    ...
    CPX #$68                ; [E0 68      ] Compare X Immediate
    BNE $55F5               ; [D0 C4      ] Branch if Not Equal
    BRK                     ; [00 24      ] Software interrupt
...
org $D45756
    ...
    BVC $57E3               ; [50 21      ] Branch if Overflow Clear
...
org $D45A3C
    ...
    ASL $04,X               ; [16 04      ] Shift Left DP,X
    TRB $06                 ; [14 06      ] Test and Reset Bits DP
    AND $06,X               ; [35 06      ] AND A with DP,X
    AND ($10),Y             ; [31 10      ] AND A with (DP),Y
    TSC                     ; [3B         ] Transfer Stack Pointer to A
    ORA ($3F),Y             ; [11 3F      ] OR A with (DP),Y
    BRK                     ; [00 06      ] Software interrupt
    ...
    BRK                     ; [00 FC      ] Software interrupt
    BRK                     ; [00 CC      ] Software interrupt
    BVS $5AA7               ; [70 BE      ] Branch if Overflow Set
    CPX #$FE                ; [E0 FE      ] Compare X Immediate
    JSR $80FE               ; [20 FE 80   ] Jump to Subroutine
    LDY $C480,X             ; [BC 80 C4   ] Load Y from Absolute,X
    PLP                     ; [28         ] Pull Processor Status
    PLA                     ; [68         ] Pull Accumulator
    BRA $5AF5               ; [80 00      ] Branch Always
    BRA $5B27               ; [80 30      ] Branch Always
    RTI                     ; [40         ] Return from Interrupt
    JMP ($2C80)             ; [6C 80 2C   ] Jump Indirect
    BRK                     ; [00 08      ] Software interrupt
    STY $50                 ; [84 50      ] Store Y to DP
    INY                     ; [C8         ] Increment Y
    AND [$04]               ; [27 04      ] AND A with [DP]
    AND [$04]               ; [27 04      ] AND A with [DP]
    ORA $0C1307,X           ; [1F 07 13 0C] OR A with Absolute Long,X
    ASL $3F1F,X             ; [1E 1F 3F   ] Shift Left Absolute,X
    ORA $3F0F4F,X           ; [1F 4F 0F 3F] OR A with Absolute Long,X

;--- Patch at file offset $145B16 (SNES $D45B16) ---
org $D45B16

    TSB $1F00               ; [0C 00 1F   ] Test and Set Bits Absolute
    BRK                     ; [00 19      ] Software interrupt
    ASL $30                 ; [06 30      ] Shift Left DP
    AND $F80000,X           ; [3F 00 00 F8] AND A with Absolute Long,X
    LDY #$F0                ; [A0 F0      ] Load Y Immediate
    LDY #$B8                ; [A0 B8      ] Load Y Immediate
    BVS $5B3F               ; [70 18      ] Branch if Overflow Set
    ...
    BRK                     ; [00 20      ] Software interrupt
    BRA $5B53               ; [80 20      ] Branch Always
    BRA $5BA5               ; [80 70      ] Branch Always
    BRK                     ; [00 F0      ] Software interrupt
    BRK                     ; [00 F8      ] Software interrupt
    PHP                     ; [08         ] Push Processor Status
    INX                     ; [E8         ] Increment X
...
org $D45CEB
    ...
    COP #$BF                ; [02 BF      ] Coprocessor interrupt
    JSL $4626BF             ; [22 BF 26 46] Jump to Subroutine Long
    ...
    ASL $3E7C               ; [0E 7C 3E   ] Shift Left Absolute
    SEI                     ; [78         ] Set Interrupt Disable
...
;--- Patch at file offset $145EA9 (SNES $D45EA9) ---
org $D45EA9

    TSB $14EA               ; [0C EA 14   ] Test and Set Bits Absolute

;--- Patch at file offset $145EB6 (SNES $D45EB6) ---
org $D45EB6

    JMP $6C80               ; [4C 80 6C   ] Jump Absolute
    RTS                     ; [60         ] Return from Subroutine
    STZ $70,X               ; [74 70      ] Store Zero to DP,X
...
org $D45FF8
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
    JSR $3D50               ; [20 50 3D   ] Jump to Subroutine
...
;--- Patch at file offset $146112 (SNES $D46112) ---
org $D46112
...
;--- Patch at file offset $146192 (SNES $D46192) ---
org $D46192
...
org $D461D8
    ...
    LDY $88,X               ; [B4 88      ] Load Y from DP,X
    STY $00,X               ; [94 00      ] Store Y to DP,X
    JMP ($28C4)             ; [6C C4 28   ] Jump Indirect
    ...
    BRK                     ; [00 FE      ] Software interrupt
    BVC $6227               ; [50 FE      ] Branch if Overflow Clear
    RTS                     ; [60         ] Return from Subroutine
...
;--- Patch at file offset $146328 (SNES $D46328) ---
org $D46328
...
org $D464D7
    ...
    SEC                     ; [38         ] Set Carry Flag
    SED                     ; [F8         ] Set Decimal Flag
    BPL $65AB               ; [10 78      ] Branch if Plus
    BRK                     ; [00 08      ] Software interrupt
    BRA $655B               ; [80 24      ] Branch Always
...
org $D46AC2
    ...
    CLC                     ; [18         ] Clear Carry Flag
    JSR ($F800,X)           ; [FC 00 F8   ] Jump to Subroutine Indirect,X
    BVS $6B1C               ; [70 E0      ] Branch if Overflow Set
    RTI                     ; [40         ] Return from Interrupt
    ...
    BVC $6B9D               ; [50 F8      ] Branch if Overflow Clear
    db $80                      ; Incomplete/data bytes
...
org $D46BFC
    ...
    TRB $0C1E               ; [1C 1E 0C   ] Test and Reset Bits Absolute
    TSB $0000               ; [0C 00 00   ] Test and Set Bits Absolute
    BEQ $6D42               ; [F0 20      ] Branch if Equal
    BEQ $6D44               ; [F0 20      ] Branch if Equal
...
org $D47860
    ...
    BRA $79EB               ; [80 70      ] Branch Always
    BVS $7985               ; [70 08      ] Branch if Overflow Set
    SEI                     ; [78         ] Set Interrupt Disable
    PHP                     ; [08         ] Push Processor Status
    SED                     ; [F8         ] Set Decimal Flag
    EOR #$02                ; [49 02      ] XOR A with Immediate
...
;--- Patch at file offset $147C9A (SNES $D47C9A) ---
org $D47C9A
...
;--- Patch at file offset $147D5A (SNES $D47D5A) ---
org $D47D5A
...
;--- Patch at file offset $147D9A (SNES $D47D9A) ---
org $D47D9A
...
;--- Patch at file offset $147EBA (SNES $D47EBA) ---
org $D47EBA
...
;--- Patch at file offset $147F1A (SNES $D47F1A) ---
org $D47F1A
...
;--- Patch at file offset $147F9A (SNES $D47F9A) ---
org $D47F9A
...
org $D48360
    ...
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 81      ] Software interrupt
    ASL $0099               ; [0E 99 00   ] Shift Left Absolute
    ADC $0F1B07             ; [6F 07 1B 0F] Add with Carry Absolute Long
    JSL $304209             ; [22 09 42 30] Jump to Subroutine Long
    AND $08,X               ; [35 08      ] AND A with DP,X
    PHP                     ; [08         ] Push Processor Status
    BRK                     ; [00 6E      ] Software interrupt
    BPL $83D9               ; [10 46      ] Branch if Plus
...
org $D483F8
    ...
    BRK                     ; [00 FE      ] Software interrupt
    BRK                     ; [00 FE      ] Software interrupt
    CPY #$2C                ; [C0 2C      ] Compare Y Immediate
    BRK                     ; [00 C4      ] Software interrupt
    PLP                     ; [28         ] Pull Processor Status
    PLA                     ; [68         ] Pull Accumulator
...
org $D48516
    ...
    TRB $40                 ; [14 40      ] Test and Reset Bits DP
    TAY                     ; [A8         ] Transfer A to Y
    STA ($0F,X)             ; [81 0F      ] Store A to (DP,X)
    TYA                     ; [98         ] Transfer Y to A
    BRK                     ; [00 6F      ] Software interrupt
    ORA [$1B]               ; [07 1B      ] OR A with [DP]
    ORA $420922             ; [0F 22 09 42] OR A with Absolute Long
...
org $D48816
    ...
    BEQ $88C1               ; [F0 00      ] Branch if Equal
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 00      ] Software interrupt
    BRK                     ; [00 07      ] Software interrupt
    BRK                     ; [00 1B      ] Software interrupt
...
org $D48B96
    ...
    PHP                     ; [08         ] Push Processor Status
    BRA $8C02               ; [80 50      ] Branch Always
    BPL $8BCC               ; [10 18      ] Branch if Plus
    CLC                     ; [18         ] Clear Carry Flag
    CLC                     ; [18         ] Clear Carry Flag
    TAY                     ; [A8         ] Transfer A to Y
...
org $D4AEC0
    ...
    CPX #$46                ; [E0 46      ] Compare X Immediate
...
org $D4AEE0
    ...
    CPX #$03                ; [E0 03      ] Compare X Immediate

;--- Patch at file offset $14AF00 (SNES $D4AF00) ---
org $D4AF00

    ASL $7C,X               ; [16 7C      ] Shift Left DP,X

;--- Patch at file offset $14AF20 (SNES $D4AF20) ---
org $D4AF20

    db $1F, $7C                 ; Incomplete/data bytes
...
org $D4AF80
    ...
    ORA ($7C,S),Y           ; [13 7C      ] OR A with (SR),Y
...
org $D4B040
    ...
    TRB $7C                 ; [14 7C      ] Test and Reset Bits DP
...
org $D4B0A0
    ...
    CPX #$01                ; [E0 01      ] Compare X Immediate
