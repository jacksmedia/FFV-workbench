;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=
; ff5_ext-1.2.ips.commented.asm
;    Disassembled from IPS patch: ff5_ext-1.2.ips
...
org $C20642
    ...
    ORA #$B9                ; [09 B9      ] OR A with Immediate
...
org $C29B57
    ...
    TAY                     ; [A8         ] Transfer A to Y
    LDX $32                 ; [A6 32      ] Load X from DP
    LDA $2623,Y             ; [B9 23 26   ] Load A from Absolute,Y
    BPL $9B62               ; [10 03      ] Branch if Plus
    TDC                     ; [7B         ] Transfer Direct Page to A
    BRA $9B65               ; [80 03      ] Branch Always
    LDA $2622,Y             ; [B9 22 26   ] Load A from Absolute,Y
    ...
    SBC [$9E]               ; [E7 9E      ] Subtract with Borrow [DP]
    BVC $9B96               ; [50 20      ] Branch if Overflow Clear
