;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=
; ff5_return.ips.commented.asm
;    Disassembled from IPS patch: ff5_return.ips
...
org $C264B2
    ...
    CMP #$21                ; [C9 21      ] Compare A Immediate
    BEQ $64FE               ; [F0 3F      ] Branch if Equal
