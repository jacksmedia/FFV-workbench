;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=;=
; ff5_core-1.5_to_1.6+monsters_magic_point+reapply_item_immunity.ips.commented.asm
;    Disassembled from IPS patch: ff5_core-1.5_to_1.6+monsters_magic_point+reapply_item_immunity.ips
